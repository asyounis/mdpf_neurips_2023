...
class Car:
    def __init__(self, car_params, sensors, XY_RANGE=20.0, max_steps_for_target=1000):
        ...
        car_max_angle_pertubation_degrees = get_parameter_safely("max_angle_pertubation_degrees", car_params, "car_params")
        max_angle_pertubation = np.radians(car_max_angle_pertubation_degrees)

        # Get the parameters for the car velocity
        velocity_params = get_parameter_safely("velocity_params", car_params, "car_params")
        self.velocities = []
...
class BearingsOnlyDataset(BaseDataset):
    def __init__(self, dataset_params, dataset_type):
        ...
        # Generate the car
        self.car_params = get_parameter_safely("car", dataset_params, "dataset_params")
