...
#SBATCH --job-name house_3dlstm								# The name of the job that is running
#SBATCH --output /scratch/ali/slurm/stdout/house_3dlstm.out  	# File to which STDOUT will be written, %j inserts jobid
#SBATCH --error /scratch/ali/slurm/stdout/house_3dlstm.err  	# File to which STDERR will be written, %j inserts jobid
...
cd /scratch/ali/Development/particle_vo/src/experiments/house3d_experiments/lstm_rnn
