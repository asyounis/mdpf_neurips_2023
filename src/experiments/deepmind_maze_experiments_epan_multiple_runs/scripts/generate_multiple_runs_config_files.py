...
def main():
    ...
    base_config_files = ["../config_files/our_experiments.yaml", "../config_files/comparison_experiments.yaml", "../config_files/our_experiments_exp3_init.yaml", "../config_files/lstm_experiments.yaml"]
