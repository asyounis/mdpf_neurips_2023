...
class BearingsOnlyObservationTransformer():
    def __init__(self):
        pass
...
class BearingsOnlyProblem(ProblemBase):
    def __init__(self, experiment, save_dir, device, dataset_types):
        ...
        self.observation_transformer = BearingsOnlyObservationTransformer()

        # Create the datasets
        for dataset_type in dataset_types:
            dataset = BearingsOnlyDataset(self.dataset_params, dataset_type)
