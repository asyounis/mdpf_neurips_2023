...
from datasets.lasot_dataset import *


class LasotObservationTransformer():
    def __init__(self):
        pass
...
class LasotProblem(ProblemBase):
    def __init__(self, experiment, save_dir, device, dataset_types):
        ...
        self.observation_transformer = LasotObservationTransformer()

        # Create the datasets
        for dataset_type in dataset_types:
            dataset = LasotDataset(self.dataset_params, dataset_type)
