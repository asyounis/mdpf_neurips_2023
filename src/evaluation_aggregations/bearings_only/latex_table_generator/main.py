...
def main():
    ...
    # BASE_EXPERIMENT_DIRS = ["bearings_only_experiments_methodical", "bearings_only_experiments_methodical_25_particles", "bearings_only_experiments_methodical_epanechnikov", "bearings_only_experiments_methodical_epanechnikov_fully"]
    BASE_EXPERIMENT_DIRS = []
    BASE_EXPERIMENT_DIRS.append("bearings_only_experiments_methodical_25_particles")
    BASE_EXPERIMENT_DIRS.append("bearings_only_experiments_methodical_epanechnikov")
    BASE_EXPERIMENT_DIRS.append("bearings_only_experiments_methodical_epanechnikov_fully")
    BASE_EXPERIMENT_DIRS.append("bearings_only_experiments_methodical_epanechnikov_gauss_init")
    BASE_EXPERIMENT_DIRS.append("bearings_only_experiments_methodical_epanechnikov_fully_gauss_init")
    ...
    experiment_names["discrete_concrete"] = "Concrete"
