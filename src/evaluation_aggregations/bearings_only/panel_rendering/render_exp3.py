...
def main():
    ...
    for sequence_to_render in tqdm(sequences_to_render):
        ...
        number_of_frames_to_render = 12
        frame_indices_to_render = [i*4 for i in range(number_of_frames_to_render)]
        frame_indices_to_render.append(14-1)
        frame_indices_to_render.append(22-1)
        frame_indices_to_render.append(24-1)
        frame_indices_to_render.append(42-1)
        ...
        experiment = "experiment0003_importance_init"
        ...
        for x in range(cols):
            for y in range(rows):
                ...
                true_state_arrow, mean_particle_arrow = render_frame(ax, sequence_data, i, experiment, true_sequence_data, dataset)
                ax.set_title("Time-step: #{:02d}".format(i+1), weight="bold", fontsize=14)
