...
def compare(data_a_name, data_b_name, metric, title, save_file_name):
    ...
    # Load the data
    data_a = load_and_preprocess_file("../../../experiments/bearings_only_experiments_methodical/{}/saves/full_dpf_evaluation_fixed_bands/raw_metric_files/aggregated_{}.pt".format(data_a_name, metric))
    data_b = load_and_preprocess_file("../../../experiments/bearings_only_experiments_methodical/{}/saves/full_dpf_evaluation_fixed_bands/raw_metric_files/aggregated_{}.pt".format(data_b_name, metric))
...
def main():
    ...
    # all possible pairs
    experiments = ["diffy_particle_filter", "optimal_transport_pf", "soft_resampling_particle_filter", "experiment0001", "experiment0002", "experiment0003"]
    ...
    for metric in metrics:
        ...
        comparison_title = "Bearings Only ({})".format(metric)
        ...
        for comparison in comparisons:
            ...
            # The save file name
            save_file_name = "{}/bearings_only_{}_{}_vs_{}.png".format(save_dir, metric, comparison[0], comparison[1])
