...
def create_initial_dpf_state_multimodal(model, true_state, observations, number_of_particles, sequence_number, world_map):
    ...
    if(sequence_number == 0):
        ...
        mode3[2] = {"std": 1.0, "pos": true_state[0, 2]}
...
def main():
    ...
    running_params_1["name"] = "True Init"
    running_params_1["save_name"] = "true_init"
    running_params_1["load_from_save"] = True
    ...
    running_params_2["name"] = "Multi-mode Init"
    running_params_2["save_name"] = "multi_mode_init"
    running_params_2["load_from_save"] = True
    ...
    running_params_3["save_name"] = "random_init"
    running_params_3["load_from_save"] = True
    ...
    for row_idx, running_params in enumerate(all_running_params):
        ...
        load_from_save = running_params["load_from_save"]
        ...
        if(load_from_save):
            ...
            # Dont want to overwrite the data that is alreadt saved
            assert(False)
        ...
        # save_file = "save_{}.pt".format(running_params["save_name"])
        # print(save_file)
        # torch.save(all_output_dicts, save_file)
